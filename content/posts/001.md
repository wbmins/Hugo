...
- **面向抽象编程**
    ...
    * 具体的业务逻辑由不同的子类实现,调用者并不关心
        ...
        + <img alt="" align="left" src="/images/Java/1.png" >  
    * 静态字段属于所有实例“共享”的字段,实际上是属于class的字段
    * 调用静态方法不需要实例,无法访问this,但可以访问静态字段和其他静态方法
    * 静态方法常用于工具类和辅助方法
    * java内建的包机制避免类名冲突
    * <img alt="" align="left" src="/images/Java/2.png" > 
    * 模块: 
        + 声明依赖关系(java9引入)
        + 使用模块按需打包jre
        + 对类的访问权限有了进一步的限制
...
- **异常体系**
    * 继承关系
        - <img alt="" align="left" src="/images/Java/3.png" > 
    * Error 严重错误,程序无能为力
...
- **容器** Collection和Map两种,Collection存储着对象的集合,而 Map存储着键值对的映射表
    ...
    - <img alt="" align="left" src="/images/Java/4.png" > 
    - 不应继续使用
...
- **设计模式** [Design Patterns GoF](http://c.biancheng.net/design_pattern/)
    ...
    - 创建型模式 对象的创建和使用分离
        ...
        + <img alt="" align="left" src="/images/Java/5.png" > 
